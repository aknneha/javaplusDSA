...
class MyFrame extends Frame 
{
    ...
    public MyFrame()
    {
        ...
        tf1.setEchoChar('*');//password
        tf2.setEchoChar('*');
        Handler h=new Handler();
        
        tf1.addTextListener(h);// tf1.addTextListener(this)--->use actionlistener with frame class and do note make the handler class
    ...
    class Handler implements TextListener,ActionListener{//inner class
